...
- [Bloc 1 - Data Governance](#bloc-1---data-governance)
  - [Objectifs](#objectifs)
  - [Contenu](#contenu)
...
Acquérir les compétences fondamentales en gouvernance des données pour architecter des solutions d'intelligence artificielle conformes et éthiques.

### Contenu

- Principes de la gouvernance des données
- Qualité et intégrité des données
- Conformité et réglementation (RGPD, IA Act)
- Gestion des métadonnées
- Stratégie de données et MLOps
...
| ------------------- | ------ | ---------------------------------------- |
| Plan de gouvernance | PDF    | Politique complète, processus, standards |
...
- ✅ Exercice des droits utilisateurs (RGPD)
