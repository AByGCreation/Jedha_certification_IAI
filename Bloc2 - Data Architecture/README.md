...
- [Bloc 2 - Data Architecture](#bloc-2---data-architecture)
  - [Objectifs](#objectifs)
  - [Contenu](#contenu)
...
- Architecture des données et design patterns
- Stockage de données (Data Lake, Data Warehouse)
- Pipelines ETL/ELT et orchestration
- Scalabilité et performance
- Sécurité et gouvernance des architectures
